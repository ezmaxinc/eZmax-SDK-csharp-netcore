...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Api
{
    ...
    public partial class ObjectEzsignsignatureApi : IObjectEzsignsignatureApi
    {
        ...
        /// <returns></returns>
        public ObjectEzsignsignatureApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.Configuration configuration)
        {
        ...
        public ObjectEzsignsignatureApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.ISynchronousClient client, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IAsynchronousClient asyncClient, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IReadableConfiguration configuration)
        {
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignsignatureCreateObjectV1Response> EzsignsignatureCreateObjectV1WithHttpInfo(List<EzsignsignatureCreateObjectV1Request> ezsignsignatureCreateObjectV1Request)
        {
            ...
            if (ezsignsignatureCreateObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignsignatureCreateObjectV1Request' when calling ObjectEzsignsignatureApi->EzsignsignatureCreateObjectV1");
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignsignatureEditObjectV1Response> EzsignsignatureEditObjectV1WithHttpInfo(int pkiEzsignsignatureID, EzsignsignatureEditObjectV1Request ezsignsignatureEditObjectV1Request)
        {
            ...
            if (ezsignsignatureEditObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignsignatureEditObjectV1Request' when calling ObjectEzsignsignatureApi->EzsignsignatureEditObjectV1");
