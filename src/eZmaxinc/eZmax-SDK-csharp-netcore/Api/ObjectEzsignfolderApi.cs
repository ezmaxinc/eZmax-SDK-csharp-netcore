...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Api
{
    ...
    public partial class ObjectEzsignfolderApi : IObjectEzsignfolderApi
    {
        ...
        /// <returns></returns>
        public ObjectEzsignfolderApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.Configuration configuration)
        {
        ...
        public ObjectEzsignfolderApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.ISynchronousClient client, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IAsynchronousClient asyncClient, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IReadableConfiguration configuration)
        {
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignfolderCreateObjectV1Response> EzsignfolderCreateObjectV1WithHttpInfo(List<EzsignfolderCreateObjectV1Request> ezsignfolderCreateObjectV1Request)
        {
            ...
            if (ezsignfolderCreateObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignfolderCreateObjectV1Request' when calling ObjectEzsignfolderApi->EzsignfolderCreateObjectV1");
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignfolderEditObjectV1Response> EzsignfolderEditObjectV1WithHttpInfo(int pkiEzsignfolderID, EzsignfolderEditObjectV1Request ezsignfolderEditObjectV1Request)
        {
            ...
            if (ezsignfolderEditObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignfolderEditObjectV1Request' when calling ObjectEzsignfolderApi->EzsignfolderEditObjectV1");
        ...
        /// <param name="pkiEzsignfolderID">The unique ID of the Ezsignfolder</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object> EzsignfolderGetChildrenV1WithHttpInfo(int pkiEzsignfolderID)
        {
            eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions localVarRequestOptions = new eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object>> EzsignfolderGetChildrenV1WithHttpInfoAsync(int pkiEzsignfolderID, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignfolderSendV1Response> EzsignfolderSendV1WithHttpInfo(int pkiEzsignfolderID, EzsignfolderSendV1Request ezsignfolderSendV1Request)
        {
            ...
            if (ezsignfolderSendV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignfolderSendV1Request' when calling ObjectEzsignfolderApi->EzsignfolderSendV1");
