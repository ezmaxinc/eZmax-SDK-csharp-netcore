...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Api
{
    ...
    public partial class ModuleSsprApi : IModuleSsprApi
    {
        ...
        /// <param name="ssprValidateTokenV1Request"></param>
        /// <returns>ApiResponse of Object(void)</returns>
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object> SsprValidateTokenV1WithHttpInfo(SsprValidateTokenV1Request ssprValidateTokenV1Request)
        {
            // verify the required parameter 'ssprValidateTokenV1Request' is set
            if (ssprValidateTokenV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ssprValidateTokenV1Request' when calling ModuleSsprApi->SsprValidateTokenV1");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object>> SsprValidateTokenV1WithHttpInfoAsync(SsprValidateTokenV1Request ssprValidateTokenV1Request, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'ssprValidateTokenV1Request' is set
            if (ssprValidateTokenV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ssprValidateTokenV1Request' when calling ModuleSsprApi->SsprValidateTokenV1");
