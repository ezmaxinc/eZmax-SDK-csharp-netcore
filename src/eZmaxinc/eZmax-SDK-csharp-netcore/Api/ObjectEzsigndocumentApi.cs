...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Api
{
    ...
    public partial class ObjectEzsigndocumentApi : IObjectEzsigndocumentApi
    {
        ...
        /// <param name="pkiEzsigndocumentID">The unique ID of the Ezsigndocument</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object> EzsigndocumentGetChildrenV1WithHttpInfo(int pkiEzsigndocumentID)
        {
            eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions localVarRequestOptions = new eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object>> EzsigndocumentGetChildrenV1WithHttpInfoAsync(int pkiEzsigndocumentID, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
