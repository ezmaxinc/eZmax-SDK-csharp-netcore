...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Api
{
    ...
    public partial class ObjectEzsignfoldersignerassociationApi : IObjectEzsignfoldersignerassociationApi
    {
        ...
        /// <returns></returns>
        public ObjectEzsignfoldersignerassociationApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.Configuration configuration)
        {
        ...
        public ObjectEzsignfoldersignerassociationApi(eZmaxinc/eZmax-SDK-csharp-netcore.Client.ISynchronousClient client, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IAsynchronousClient asyncClient, eZmaxinc/eZmax-SDK-csharp-netcore.Client.IReadableConfiguration configuration)
        {
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignfoldersignerassociationCreateObjectV1Response> EzsignfoldersignerassociationCreateObjectV1WithHttpInfo(List<EzsignfoldersignerassociationCreateObjectV1Request> ezsignfoldersignerassociationCreateObjectV1Request)
        {
            ...
            if (ezsignfoldersignerassociationCreateObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignfoldersignerassociationCreateObjectV1Request' when calling ObjectEzsignfoldersignerassociationApi->EzsignfoldersignerassociationCreateObjectV1");
        ...
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<EzsignfoldersignerassociationEditObjectV1Response> EzsignfoldersignerassociationEditObjectV1WithHttpInfo(int pkiEzsignfoldersignerassociationID, EzsignfoldersignerassociationEditObjectV1Request ezsignfoldersignerassociationEditObjectV1Request)
        {
            ...
            if (ezsignfoldersignerassociationEditObjectV1Request == null)
                throw new eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiException(400, "Missing required parameter 'ezsignfoldersignerassociationEditObjectV1Request' when calling ObjectEzsignfoldersignerassociationApi->EzsignfoldersignerassociationEditObjectV1");
        ...
        /// <param name="pkiEzsignfoldersignerassociationID">The unique ID of the Ezsignfoldersignerassociation</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object> EzsignfoldersignerassociationGetChildrenV1WithHttpInfo(int pkiEzsignfoldersignerassociationID)
        {
            eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions localVarRequestOptions = new eZmaxinc/eZmax-SDK-csharp-netcore.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<eZmaxinc/eZmax-SDK-csharp-netcore.Client.ApiResponse<Object>> EzsignfoldersignerassociationGetChildrenV1WithHttpInfoAsync(int pkiEzsignfoldersignerassociationID, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
