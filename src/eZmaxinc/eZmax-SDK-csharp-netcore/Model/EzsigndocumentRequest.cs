...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Model
{
    ...
    public partial class EzsigndocumentRequest : IEquatable<EzsigndocumentRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates where to look for the document binary content.</value>
        [DataMember(Name = "eEzsigndocumentSource", EmitDefaultValue = false)]
        ...
        public EzsigndocumentRequest(EEzsigndocumentSourceEnum eEzsigndocumentSource = default(EEzsigndocumentSourceEnum), EEzsigndocumentFormatEnum eEzsigndocumentFormat = default(EEzsigndocumentFormatEnum), byte[] sEzsigndocumentBase64 = default(byte[]), int fkiEzsignfolderID = default(int), string dtEzsigndocumentDuedate = default(string), int fkiLanguageID = default(int), string sEzsigndocumentFilename = default(string), string sEzsigndocumentName = default(string))
        {
            ...
            this.dtEzsigndocumentDuedate = dtEzsigndocumentDuedate ?? throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsigndocumentRequest and cannot be null");
            this.fkiLanguageID = fkiLanguageID;
            // to ensure "sEzsigndocumentFilename" is required (not null)
            this.sEzsigndocumentFilename = sEzsigndocumentFilename ?? throw new ArgumentNullException("sEzsigndocumentFilename is a required property for EzsigndocumentRequest and cannot be null");
            // to ensure "sEzsigndocumentName" is required (not null)
            this.sEzsigndocumentName = sEzsigndocumentName ?? throw new ArgumentNullException("sEzsigndocumentName is a required property for EzsigndocumentRequest and cannot be null");
