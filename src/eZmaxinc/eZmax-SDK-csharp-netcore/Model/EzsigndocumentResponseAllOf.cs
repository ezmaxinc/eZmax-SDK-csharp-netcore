...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ezsigndocument_Response_allOf")]
    public partial class EzsigndocumentResponseAllOf : IEquatable<EzsigndocumentResponseAllOf>, IValidatableObject
    {
        ...
        public EzsigndocumentResponseAllOf(int fkiEzsignfolderID = default(int), string dtEzsigndocumentDuedate = default(string), int fkiLanguageID = default(int), string sEzsigndocumentFilename = default(string), string sEzsigndocumentName = default(string), int pkiEzsigndocumentID = default(int), FieldEEzsigndocumentStep eEzsigndocumentStep = default(FieldEEzsigndocumentStep), string dtEzsigndocumentFirstsend = default(string), string dtEzsigndocumentLastsend = default(string), int iEzsigndocumentOrder = default(int), int iEzsigndocumentPagetotal = default(int), int iEzsigndocumentSignaturesigned = default(int), int iEzsigndocumentSignaturetotal = default(int), string sEzsigndocumentMD5initial = default(string), string sEzsigndocumentMD5signed = default(string), CommonAudit objAudit = default(CommonAudit))
        {
            ...
            this.dtEzsigndocumentDuedate = dtEzsigndocumentDuedate ?? throw new ArgumentNullException("dtEzsigndocumentDuedate is a required property for EzsigndocumentResponseAllOf and cannot be null");
            this.fkiLanguageID = fkiLanguageID;
            // to ensure "sEzsigndocumentFilename" is required (not null)
            this.sEzsigndocumentFilename = sEzsigndocumentFilename ?? throw new ArgumentNullException("sEzsigndocumentFilename is a required property for EzsigndocumentResponseAllOf and cannot be null");
            // to ensure "sEzsigndocumentName" is required (not null)
            this.sEzsigndocumentName = sEzsigndocumentName ?? throw new ArgumentNullException("sEzsigndocumentName is a required property for EzsigndocumentResponseAllOf and cannot be null");
            this.pkiEzsigndocumentID = pkiEzsigndocumentID;
            // to ensure "eEzsigndocumentStep" is required (not null)
            this.eEzsigndocumentStep = eEzsigndocumentStep ?? throw new ArgumentNullException("eEzsigndocumentStep is a required property for EzsigndocumentResponseAllOf and cannot be null");
            // to ensure "dtEzsigndocumentFirstsend" is required (not null)
            this.dtEzsigndocumentFirstsend = dtEzsigndocumentFirstsend ?? throw new ArgumentNullException("dtEzsigndocumentFirstsend is a required property for EzsigndocumentResponseAllOf and cannot be null");
            // to ensure "dtEzsigndocumentLastsend" is required (not null)
            this.dtEzsigndocumentLastsend = dtEzsigndocumentLastsend ?? throw new ArgumentNullException("dtEzsigndocumentLastsend is a required property for EzsigndocumentResponseAllOf and cannot be null");
            ...
            this.sEzsigndocumentMD5initial = sEzsigndocumentMD5initial ?? throw new ArgumentNullException("sEzsigndocumentMD5initial is a required property for EzsigndocumentResponseAllOf and cannot be null");
            // to ensure "sEzsigndocumentMD5signed" is required (not null)
            this.sEzsigndocumentMD5signed = sEzsigndocumentMD5signed ?? throw new ArgumentNullException("sEzsigndocumentMD5signed is a required property for EzsigndocumentResponseAllOf and cannot be null");
            // to ensure "objAudit" is required (not null)
            this.objAudit = objAudit ?? throw new ArgumentNullException("objAudit is a required property for EzsigndocumentResponseAllOf and cannot be null");
        }
