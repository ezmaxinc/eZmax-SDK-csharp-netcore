...
namespace eZmaxinc/eZmax-SDK-csharp-netcore.Test.Api
{
    ...
    /// </remarks>
    public class FranchiseofficeApiTests : IDisposable
    {
        private FranchiseofficeApi instance;

        public FranchiseofficeApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' FranchiseofficeApi
            //Assert.IsType<FranchiseofficeApi>(instance);
        }
